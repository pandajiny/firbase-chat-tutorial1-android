...
//        set each button for onClickListener
        val profileButton = rootView.findViewById<Button>(R.id.navProfileButton)
        ...
        rootView.findViewById<Button>(R.id.navChatListButton).setOnClickListener {
            activity?.let {
